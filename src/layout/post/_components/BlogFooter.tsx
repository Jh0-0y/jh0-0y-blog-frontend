      ...
      <div className={styles.waveWrapper}>
        <svg className={styles.waves} xmlns="http://www.w3.org/2000/svg" viewBox="0 24 150 28" preserveAspectRatio="none">
          ...
          <g className={styles.parallax}>
            <use xlinkHref="#gentle-wave-footer" x="48" y="0" className={styles.waveLayer1} />
            <use xlinkHref="#gentle-wave-footer" x="48" y="7" className={styles.waveLayer2} />
          </g>
        </svg>
      </div>
      {/* 상단 영역 */}
      ...
      <div className={styles.content}>
        <div className={styles.top}>
          ...
          <div className={styles.section}>
            <h3 className={styles.sectionTitle}>DevLog</h3>
            <p className={styles.description}>
              개발자의 성장 기록과 기술 노트를 공유하는 공간입니다.
            </p>
          ...
          {/* 링크 */}
          <div className={styles.section}>
            <h4 className={styles.sectionTitle}>링크</h4>
            <ul className={styles.links}>
        ...
        <div className={styles.bottom}>
          <p className={styles.copyright}>
            © {currentYear} DevLog. All rights reserved.
          </p>
